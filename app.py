...
def login_page():
    ...
    st.write("Ian A·chik AI ong. Jean Pingrak G Momin-ni tarigipa onga.")
    ...
    if st.button("Napbo (Login)"):
        if email == "kasarasank@gmail.com":
            if password == correct_password:
                ...
                st.error("❌ Password Manjawa Kuliramramnabe na.a gualahakon! Access Denied!")
        elif email != "":
...
def user_panel():
    ...
    st.caption("Pingrak G Momin tariaha.")
